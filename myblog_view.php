                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="pull-right">
                                                ...
                                                <button class="btn btn-default btn-sm" type="button" onclick="window.location='myblog_reply.php'">답글</button>
                                                <button class="btn btn-default btn-sm" type="button" onclick="window.location='myblog_modify.php'">수정</button>
